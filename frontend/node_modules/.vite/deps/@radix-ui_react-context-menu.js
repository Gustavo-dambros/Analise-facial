...
import {
  ...
  Root2,
  createPopperScope
} from "./chunk-OITMQU7C.js";
import {
  Combination_default,
  FocusScope,
  hideOthers,
  useFocusGuards
} from "./chunk-6CVTO245.js";
import {
  DismissableLayer,
  Portal,
  Presence,
  ...
  useId
} from "./chunk-4O4QKJQT.js";
import "./chunk-6WBQ3PW6.js";
import {
  IS_DEVELOPMENT,
  useCallbackRef,
  useLayoutEffect2
} from "./chunk-R2V72OYX.js";
import {
  createContextScope
} from "./chunk-OUWHIFSC.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-BUKOY36J.js";
import {
  createSlot,
  useComposedRefs
...
var ContextMenu = __name4((props) => {
  const { __scopeContextMenu, children, onOpenChange, open: openProp, dir, modal = true } = props;
  const hasInteractedRef = React5.useRef(false);
  if (IS_DEVELOPMENT) {
    const hasWarnedRef = React5.useRef(false);
    React5.useEffect(() => {
  ...
  return (0, import_jsx_runtime3.jsx)(
    ContextMenuProvider,
    {
      ...
      modal,
      hasInteractedRef,
      children: (0, import_jsx_runtime3.jsx)(Root3, { ...menuScope, dir, open, onOpenChange: setOpen, modal, children })
    }
  );
}, "ContextMenu");
var TRIGGER_NAME = "ContextMenuTrigger";
var ContextMenuTrigger = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function ContextMenuTrigger2(props, forwardedRef) {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const [point, setPoint] = React5.useState({ x: 0, y: 0 });
    const virtualRef = React5.useMemo(
      () => ({
        current: {
          getBoundingClientRect: __name4(() => DOMRect.fromRect({ width: 0, height: 0, ...point }), "getBoundingClientRect")
        }
      }),
      [point]
    );
    const longPressTimerRef = React5.useRef(0);
    const clearLongPress = React5.useCallback(
      () => window.clearTimeout(longPressTimerRef.current),
      []
    );
    const handleOpen = __name4((event) => {
      context.hasInteractedRef.current = true;
      setPoint({ x: event.clientX, y: event.clientY });
      context.onOpenChange(true);
    }, "handleOpen");
    React5.useEffect(() => clearLongPress, [clearLongPress]);
    React5.useEffect(() => void (disabled && clearLongPress()), [disabled, clearLongPress]);
...
var ContextMenuPortal = __name4((props) => {
  const { __scopeContextMenu, ...portalProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime3.jsx)(Portal2, { ...menuScope, ...portalProps });
}, "ContextMenuPortal");
var CONTENT_NAME2 = "ContextMenuContent";
var ContextMenuContent = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function ContextMenuContent2(props, forwardedRef) {
...
var ContextMenuGroup = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function ContextMenuGroup2(props, forwardedRef) {
    const { __scopeContextMenu, ...groupProps } = props;
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime3.jsx)(Group, { ...menuScope, ...groupProps, ref: forwardedRef });
  }, "ContextMenuGroup")
);
var ContextMenuLabel = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function ContextMenuLabel2(props, forwardedRef) {
    const { __scopeContextMenu, ...labelProps } = props;
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime3.jsx)(Label, { ...menuScope, ...labelProps, ref: forwardedRef });
  }, "ContextMenuLabel")
);
var ContextMenuItem = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function ContextMenuItem2(props, forwardedRef) {
    const { __scopeContextMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime3.jsx)(Item2, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "ContextMenuItem")
);
var ContextMenuCheckboxItem = React5.forwardRef(__name4(function ContextMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeContextMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime3.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "ContextMenuCheckboxItem"));
var ContextMenuRadioGroup = React5.forwardRef(__name4(function ContextMenuRadioGroup2(props, forwardedRef) {
  const { __scopeContextMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime3.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "ContextMenuRadioGroup"));
var ContextMenuRadioItem = React5.forwardRef(__name4(function ContextMenuRadioItem2(props, forwardedRef) {
  const { __scopeContextMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime3.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "ContextMenuRadioItem"));
var ContextMenuItemIndicator = React5.forwardRef(__name4(function ContextMenuItemIndicator2(props, forwardedRef) {
  const { __scopeContextMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime3.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "ContextMenuItemIndicator"));
var ContextMenuSeparator = React5.forwardRef(__name4(function ContextMenuSeparator2(props, forwardedRef) {
  const { __scopeContextMenu, ...separatorProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime3.jsx)(Separator, { ...menuScope, ...separatorProps, ref: forwardedRef });
}, "ContextMenuSeparator"));
var ContextMenuArrow = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function ContextMenuArrow2(props, forwardedRef) {
...
var ContextMenuSub = __name4((props) => {
...
var ContextMenuSubTrigger = React5.forwardRef(__name4(function ContextMenuSubTrigger2(props, forwardedRef) {
  const { __scopeContextMenu, ...triggerItemProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime3.jsx)(SubTrigger, { ...menuScope, ...triggerItemProps, ref: forwardedRef });
}, "ContextMenuSubTrigger"));
var ContextMenuSubContent = React5.forwardRef(__name4(function ContextMenuSubContent2(props, forwardedRef) {
...
__name4(whenTouchOrPen, "whenTouchOrPen");
