...
async function applyServerStorage({ getAll, setAll, setItems, removedItems }, options) {
  ...
  const cookieNames = (allCookies == null ? void 0 : allCookies.map(({ name }) => name)) || [];
  const currentByName = new Map((allCookies == null ? void 0 : allCookies.map(({ name, value }) => [name, value])) || []);
...
https://supabase.com/dashboard/project/_/settings/api`);
  ...
  const client = createClient(supabaseUrl, supabaseKey, {
    ...
    auth: {
      ...
      flowType: "pkce",
      autoRefreshToken: ((_c = options == null ? void 0 : options.auth) == null ? void 0 : _c.autoRefreshToken) ?? isBrowser(),
      detectSessionInUrl: ((_d = options == null ? void 0 : options.auth) == null ? void 0 : _d.detectSessionInUrl) ?? isBrowser(),
